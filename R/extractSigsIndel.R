...
extractSigsIndel <- function(vcf.file, sample.name = NULL, ref.genome = DEFAULT_GENOME,
   ...
   if(is.data.frame(variants) && !is.na(variants)){ ## Deal with empty vcfs
      ...
      # write.table(sig_components, '/Users/lnguyen/hpc/cog_bioinf/cuppen/project_data/Luan_PCAGW/scripts/mutSigExtractor/R_source/call_indel_signatures_v2/CPCT02220031R_CPCT02220031T_indel_sig_final_dataframe.txt', sep = '\t')
